...
type DummyServiceClient interface {
	GetDummy(ctx context.Context, in *GetDummyRequest, opts ...grpc.CallOption) (*GetDummyResponse, error)
}
...
func (c *dummyServiceClient) GetDummy(ctx context.Context, in *GetDummyRequest, opts ...grpc.CallOption) (*GetDummyResponse, error) {
	out := new(GetDummyResponse)
	err := c.cc.Invoke(ctx, "/loghouse_test.DummyService/GetDummy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DummyServiceServer interface {
	GetDummy(context.Context, *GetDummyRequest) (*GetDummyResponse, error)
...
func (UnimplementedDummyServiceServer) GetDummy(context.Context, *GetDummyRequest) (*GetDummyResponse, error) {
...
func _DummyService_GetDummy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loghouse_test.DummyService/GetDummy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DummyServiceServer).GetDummy(ctx, req.(*GetDummyRequest))
	}
...
var DummyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "loghouse_test.DummyService",
	...
	Metadata: "api/loghouse_test/loghouse_test.proto",
}
