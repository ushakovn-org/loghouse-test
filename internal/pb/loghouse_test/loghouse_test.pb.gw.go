...
/*
Package loghouse_test is a reverse proxy.
...
func request_DummyService_GetDummy_0(ctx context.Context, marshaler runtime.Marshaler, client DummyServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDummyRequest
...
func local_request_DummyService_GetDummy_0(ctx context.Context, marshaler runtime.Marshaler, server DummyServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDummyRequest
	var metadata runtime.ServerMetadata
...
func RegisterDummyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DummyServiceServer) error {
	...
	mux.Handle("POST", pattern_DummyService_GetDummy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/loghouse_test.DummyService/GetDummy", runtime.WithHTTPPathPattern("/loghouse_test.DummyService/GetDummy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DummyService_GetDummy_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_DummyService_GetDummy_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDummyServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DummyServiceClient) error {
	...
	mux.Handle("POST", pattern_DummyService_GetDummy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/loghouse_test.DummyService/GetDummy", runtime.WithHTTPPathPattern("/loghouse_test.DummyService/GetDummy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DummyService_GetDummy_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_DummyService_GetDummy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"loghouse_test.DummyService", "GetDummy"}, ""))
)

var (
	forward_DummyService_GetDummy_0 = runtime.ForwardResponseMessage
)
