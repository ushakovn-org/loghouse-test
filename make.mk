...
generate-protoc:
	...
	--plugin=protoc-gen-validate=${PWD}/bin/protoc-gen-validate \
	\
	--go_out=. --go_opt=paths=import --go_opt=module=github.com/ushakovn/ushakovn-org/loghouse-test \
	--go-grpc_out=. --go-grpc_opt=paths=import --go-grpc_opt=module=github.com/ushakovn/ushakovn-org/loghouse-test \
	--grpc-gateway_out=. --grpc-gateway_opt=paths=import --grpc-gateway_opt=module=github.com/ushakovn/ushakovn-org/loghouse-test \
	--grpc-gateway_opt generate_unbound_methods=true \
	--openapiv2_out=docs/. --openapiv2_opt output_format=yaml \
    --openapiv2_opt generate_unbound_methods=true --openapiv2_opt allow_merge=true \
	--validate_out="lang=go,module=github.com/ushakovn/ushakovn-org/loghouse-test,paths=import:." \
	\
	./api/**/*.proto
